 ...
 */
am_static_inline
void amhw_gpio_pin_init_out_low (amhw_gpio_t *p_hw_gpio, int pin)
{
 ...
 */
am_static_inline
void amhw_gpio_pin_init_out_high (amhw_gpio_t *p_hw_gpio, int pin)
{
    p_hw_gpio->gpio[pin >> 5].pdor |= (1ul << (pin & 0x1F));
}
 ...
 */
am_static_inline
int amhw_gpio_pin_init_get (amhw_gpio_t *p_hw_gpio, int pin)
{
 ...
 */
am_static_inline
void amhw_gpio_pin_out_toggle (amhw_gpio_t *p_hw_gpio, int pin)
{
 ...
 */
am_static_inline
int amhw_gpio_pin_input_get (amhw_gpio_t *p_hw_gpio, int pin)
{
 ...
 */
am_static_inline
void amhw_fgpio_pin_init_out_low (amhw_fgpio_t *p_hw_fgpio, int pin)
{
 ...
 */
am_static_inline
void amhw_fgpio_pin_init_out_high (amhw_fgpio_t *p_hw_fgpio, int pin)
{
    p_hw_fgpio->fgpio[pin >> 5].pdor |= (1ul << (pin & 0x1F));
}
 ...
 */
am_static_inline
int amhw_fgpio_pin_init_get (amhw_fgpio_t *p_hw_fgpio, int pin)
{
 ...
 */
am_static_inline
void amhw_fgpio_pin_out_high (amhw_fgpio_t *p_hw_fgpio, int pin)
{
 ...
 */
am_static_inline
void amhw_fgpio_pin_out_low (amhw_fgpio_t *p_hw_fgpio, int pin)
{
 ...
 */
am_static_inline
void amhw_fgpio_pin_out_toggle (amhw_fgpio_t *p_hw_fgpio, int pin)
{
 ...
 */
am_static_inline
int amhw_fgpio_pin_input_get (amhw_fgpio_t *p_hw_fgpio, int pin)
{
 ...
 */
am_static_inline
void amhw_fgpio_pin_dir_input (amhw_fgpio_t *p_hw_fgpio, int pin)
{
 ...
 */
am_static_inline
void amhw_fgpio_pin_dir_output (amhw_fgpio_t *p_hw_fgpio, int pin)
{
    p_hw_fgpio->fgpio[pin >> 5].pddr |= (1ul << (pin & 0x1F));
}
 ...
 */
am_static_inline
int amhw_fgpio_pin_dir_get (amhw_fgpio_t *p_hw_fgpio, int pin)
{
