...
#define AMHW_RCM_RESTFLAG_POR     AM_BIT(15) /**< \brief 上电复位             */
#define AMHW_RCM_RESTFLAG_PIN     AM_BIT(14) /**< \brief REST引脚复位         */
#define AMHW_RCM_RESTFLAG_WDOG    AM_BIT(13) /**< \brief 看门狗复位           */
#define AMHW_RCM_RESTFLAG_LOL     AM_BIT(11) /**< \brief 锁相环异常           */
#define AMHW_RCM_RESTFLAG_LOC     AM_BIT(10) /**< \brief 时钟丢失复位         */
#define AMHW_RCM_RESTFLAG_LVD     AM_BIT(19) /**< \brief 低电压检测复位       */
#define AMHW_RCM_RESTFLAG_WAKEUP  AM_BIT(18) /**< \brief 唤醒复位             */
#define AMHW_RCM_RESTFLAG_SACKERR AM_BIT(5)  /**< \brief 停止模式进入错误复位 */
#define AMHW_RCM_RESTFLAG_MDM_AP  AM_BIT(3)  /**< \brief 调试复位             */
#define AMHW_RCM_RESTFLAG_SW      AM_BIT(2)  /**< \brief 软件复位             */
#define AMHW_RCM_RESTFLAG_LOCKUP  AM_BIT(1)  /**< \brief 内核Lockup事件复位   */
 ...
 *
 * \param[in] p_hw_rcm : 指向PMC寄存器块的指针
 * \param[in] flag     : 滤波时钟配置选项，AMHW_RCM_RESPIN_FILT_STOP_*宏值
 ...
 *
 * \param[in] p_hw_rcm : 指向PMC寄存器块的指针
 * \param[in] flag     : 滤波时钟配置选项，AMHW_RCM_RESPIN_FILT_RUNW_*宏值
