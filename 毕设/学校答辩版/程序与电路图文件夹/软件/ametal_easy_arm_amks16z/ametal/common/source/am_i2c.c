                  ...
                  uint32_t         nbytes)
{
    ...
    if (subaddr_len == 0) {
        ...
        am_i2c_transfer(p_dev->handle, &trans);
    ...
    am_i2c_mktrans(&trans,
                   p_dev->dev_addr,
                   (p_dev->dev_flags | AM_I2C_M_NOSTART | 
                    AM_I2C_M_WR      | AM_I2C_M_STOP),
                   (uint8_t *)p_buf, 
                   nbytes,
                    __i2c_callback,
                   (void *)&trans_wait);
                 ...
                 uint32_t         nbytes)
{
   ...
   // am_udelay(500);
    ...
    am_i2c_mktrans(&trans,
                   p_dev->dev_addr,
                   (p_dev->dev_flags | AM_I2C_M_RD | AM_I2C_M_STOP),
                   (uint8_t *)p_buf, 
                   nbytes,
                   __i2c_callback,
                   (void *)&trans_wait);
